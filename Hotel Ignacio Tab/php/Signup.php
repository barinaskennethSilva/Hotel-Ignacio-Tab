...
<div class="SignUp shadow rounded">
  ...
  <span style="font-size:12px;text-align: center;">Create New Account</span>
     </div>
 
<form action="SignForm.php"method="POST"   enctype="multipart/form-data"id="SignUpform">
     <div class="form1"id="form1">
      <input type="hidden" name="usertype"value="user"hidden>
  <div class="mb-3">
...
<div class="btn-signUp">
   ...
   <p id="signUp"class="mb-4 mt-3">Login Existed Account <a href="Login.php">Login</a></p>
</form>
</div>
</body>
</html>